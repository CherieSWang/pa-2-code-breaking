...
#creates the vectors of letters and punctuations
...
#combining symbols from the first three vectors
...
```{r}
#|label: my_symbols-dataframe
#changing my_symbol's from vector to data frame
...
```{r}
#|label: counting-symbols
#counting total number of symbols in data frame
...
```{r}
#|label: assigning-numbers
#assigning a number to each symbol in my_symbols
